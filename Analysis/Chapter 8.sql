...
COPY pls_fy2014_pupld14a FROM 'C:\Users\thlok\Documents\3. SQL Module\Analysis\pls_fy2014_pupld14a.csv' WITH (FORMAT CSV, HEADER);
...
COPY pls_fy2009_pupld09a FROM 'C:\Users\thlok\Documents\3. SQL Module\Analysis\pls_fy2009_pupld09a.csv' WITH (FORMAT CSV, HEADER);
...
SELECT *                   ---- 2014: shows the whole table
FROM pls_fy2014_pupld14a;

SELECT count(*)
FROM pls_fy2009_pupld09a;

SELECT *                   ---- 2009: shows the whole table
FROM pls_fy2009_pupld09a;
...
FROM pls_fy2014_pupld14a
GROUP BY libname                 -------groups duplicate names and shows them as one value
ORDER BY count(libname) DESC;    -------counts the duplicates

-- Bonus: see location of every Oxford Public Library
SELECT libname, city, stabr  ----stabr: State
FROM pls_fy2014_pupld14a
...
FROM pls_fy2014_pupld14a
GROUP BY city, stabr  -----looks at distinct values (combinations): group by combinations
ORDER BY count(*) DESC;
...
ORDER BY stabr ASC, count(*) DESC;  -----sorts within state group
...
FROM pls_fy2014_pupld14a pls14 JOIN pls_fy2009_pupld09a AS pls09
